...
var ApprovalStatusFilter = React.createClass({
    ...
    _renderRadioGroupOptions: function () {
        ...
        components.push(
            ...
            filterOption(value, 'Pending Deletion', 'PENDING_DELETION', counts.PENDING_DELETION, 'all-listings-filter-pending-deletion', 'label-pending-deletion', 'icon-trash-12-blueDarker')
        );
        return components;
    },
